...
Route::middleware(['check.subscription'])->group(function () {
    ...
    Route::get('/restaurants', [App\Http\Controllers\VendorsController::class, 'index'])->name('restaurants');

    Route::get('/restaurants/edit/{id}', [App\Http\Controllers\VendorsController::class, 'edit'])->name('restaurants.edit');
