...
?>
<div class="container ghalbit-register-shell">
    <div class="row page-titles ghalbit-register-header">

        <div class="col-md-12 align-self-center text-center">
            <h3 class="text-themecolor  ">{{trans('lang.sign_up_with_us')}}</h3>
        </div>

        <div class="card-body ghalbit-register-panel">
        <div id="data-table_processing" class="page-overlay" style="display:none;">
            ...
            <div class="row restaurant_payout_create">
                <div class="restaurant_payout_create-inner">
                    <fieldset>
                        <legend>Store Panel Registration</legend>
