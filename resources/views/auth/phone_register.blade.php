...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title id="app_name">GHALBIT MARITRONIX Store Panel</title>
    ...
    <body class="ghalbit-login-body">
        ...
        <section id="wrapper">
            ...
            <div class="login-register ghalbit-login-shell" style="background-color:<?php echo $_COOKIE['store_panel_color']; ?>;">
                <?php } else{ ?>

                <div class="login-register ghalbit-login-shell" style="background-color:#FF683A;">
                    <?php } ?>


                    <div class="login-logo text-center py-3 ghalbit-login-brand" style="margin-top:5%;">
                        <a href="#" class="ghalbit-login-brand__panel">
                    ...
                    <div class="login-box card ghalbit-login-card" style="margin-bottom:0%;">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal form-material" name="loginwithphon" id="login-with-phone-box"
                                action="#">
                                @csrf
                                <div class="box-title m-b-20">Store Panel Sign Up</div>
