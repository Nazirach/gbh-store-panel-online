...
<script src="https://cdnjs.cloudflare.com/ajax/libs/crypto-js/3.1.9-1/crypto-js.js"></script>
 <script>
    ...
    // SERVICE_60J_STORE_PANEL_VENDOR_GEO_CONTRACT_PATCH
	...
	$(document).ready(function(){
		...
		$(".save_vendor_btn").click(function(){
		    ...
		    geoFirestore.collection('vendors').doc(id).update({'title':vendorname,'description':description,'latitude':latitude,
