...
<script>
  ...
  $(".save_coupon_btn").click(async function () {
    ...
    let vendorUserRef = await database.collection('users').doc(vendorUserId).get();
    let vendorUserData = vendorUserRef.data();
    let vandorId = vendorUserData.vendorID;
    let section_id = vendorUserData.sectionId;
