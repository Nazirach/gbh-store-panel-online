...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" <?php if (str_replace('_', '-', app()->getLocale()) == 'ar' || @$_COOKIE['is_rtl'] == 'true') { ?> dir="rtl" <?php } ?>>
    ...
    <body class="ghalbit-vendor-theme">
                ...
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="{{ url('orders') }}" id="notification_url">{{trans('lang.go')}}</a></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            database.collection('settings').doc("notification_setting").get().then(async function(snapshots) {
                var data = (typeof snapshots.data === 'function' ? (snapshots.data() || {}) : {});
                ...
                if (serviceJson != '' && serviceJson != null) {
                    ...
                    console.warn('Store Panel notification service JSON missing; service file sync skipped safely.');
                }
            });
